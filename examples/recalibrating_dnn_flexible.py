...
from epftoolbox.dnn.recalibration_and_forecasting import DNNRecalibration, recalibrate_and_forecast_next_day
...
parser.add_argument("--years_test", type=int, default=4, 
...
parser.add_argument("--new_recalibration", type=int, default=0, 
...
model = DNNRecalibration(
    experiment_id=experiment_id, path_datasets=path_datasets, 
    hyperparameter_files=hyperparameter_files, nlayers=nlayers, dataset=dataset, 
